//7 - Escreva um novo programa, alterando o exercício 6, e leia mais um número inteiro e verifique se ele é igual a algum dos anteriores. 
...
public class Exercicio7 {
    ...
    public static void Leitor_e_Busca_Linear(){
        ...
        if(i == vetor.length){
            System.out.println("Nao foi possivel achar o numero desejado. ");
        }else{
